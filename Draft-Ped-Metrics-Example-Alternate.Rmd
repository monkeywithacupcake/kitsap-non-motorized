...
- *change in alternate* 2 if a shoulder is present of adequate width when a sidewalk should be present (based on road classification & standards)
- *change in alternate* 1 if there is any sidewalk or shoulder but not wide enough
