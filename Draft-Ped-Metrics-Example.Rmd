...
kitsap +
  ...
  labs(title = 'Kitsap County Public Schools',
       ...
       caption = "Data source: Kitsap GIS - data in development\n
                  Walking distance polygons from Mapbox",
       fill = "Public Schools")

```


```{r loop_pubschools,include=FALSE,echo=FALSE, cache=TRUE}
...
kitsap +
  ...
  labs(title = 'Kitsap County Transit Centers and Transfer Points',
       ...
       caption = "Data source: Kitsap Transit Website\n
                  Walking distance polygons from Mapbox",
