...
#distance is the length of the matched road segment and sidewalk or shoulder 
#comb %>% st_set_geometry(., NULL) %>% 
...
Kitsap County has `r nrow(libraries)`
